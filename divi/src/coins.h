 ...
 *               * 8358: compact amount representation for 60000000000 (600 DIVI)
 ...
 *             * 86ef97d579: compact amount representation for 234925952 (2.35 DIVI)
 *             * 00: special txout type pay-to-pubkey-hash
 *             * 61b01caab50f1b8e9c50a5057eb43c2d9563a4ee: address uint160
 *  - vout[16]: bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4
 *              * bbd123: compact amount representation for 110397 (0.001 DIVI)
 *              * 00: special txout type pay-to-pubkey-hash
...
public:
    ...
    virtual bool GetCoins(const OutputHash& txid, CCoins& coins) const;

    //! Just check whether we have data for a given txid.
    //! This may (but cannot always) return true for fully spent transactions
    virtual bool HaveCoins(const OutputHash& txid) const;
